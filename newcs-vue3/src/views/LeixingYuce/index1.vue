      ...
      <el-card v-if="activeModule === 'input'" class="module" style="width: 100%;">
        ...
        <el-form label-position="top" style="margin-top: 20px;">
          ...
          <el-form-item label="选择输入方式:">
            <el-select v-model="inputMethod" placeholder="选择输入方式">
          ...
          <!-- SMILES 字符串输入框 -->
          <el-form v-if="inputMethod === 'string'" label-position="top">
        ...
        <!-- 如果选择了上传文件方式 -->
        <el-form v-if="inputMethod === 'file'" label-position="top" style="margin-top: 20px;">
          <el-form-item label="上传SMILES文件（.tsv格式）:">
            <el-upload class="upload-demo" drag :before-upload="() => false"
              @change="handleFileChange($event, 'smilesFile')" accept=".tsv">
              <i class="el-icon-upload"></i>
              <div class="el-upload__text">点击或拖拽文件上传</div>
            </el-upload>
          </el-form-item>

          <el-form-item label="上传预测模型压缩包（选填，默认使用默认模型）:">
            <el-upload class="upload-demo" drag :before-upload="() => false"
              @change="handleFileChange($event, 'modelFile2')">
              <i class="el-icon-upload"></i>
              <div class="el-upload__text">点击或拖拽文件上传</div>
            </el-upload>
          </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" @click="submitFilePrediction">提交信息</el-button>
          </el-form-item>
        </el-form>
        <h3 class="result-card">
          预测结果
          <el-tooltip placement="top" effect="dark" popper-class="reaction-tooltip">
            ...
            <template v-slot:content>
              <div class="reaction-list">
                <ul>
                  <li>Aldehyde reductive amination</li>
                  <li>Eschweiler-Clarke methylation</li>
                  <li>Ketone reductive amination</li>
                  <li>Bromo N-arylation</li>
                  <li>Chloro N-arylation</li>
                  <li>Fluoro N-arylation</li>
                  <li>Bromo N-alkylation</li>
                  <li>Chloro N-alkylation</li>
                  <li>Iodo N-alkylation</li>
                  <li>Hydroxy to methoxy</li>
                  <li>Methyl esterification</li>
                  <li>Mitsunobu aryl ether synthesis</li>
                  <li>Williamson ether synthesis</li>
                  <li>Thioether synthesis</li>
                  <li>Bromination</li>
                  <li>Chlorination</li>
                  <li>Wohl-Ziegler bromination</li>
                  <li>Nitration</li>
                  <li>Methylation</li>
                  <li>Amide Schotten-Baumann</li>
                  <li>Carboxylic acid + amine reaction</li>
                  <li>N-acetylation</li>
                  <li>Sulfonamide Schotten-Baumann</li>
                  <li>Isocyanate + amine reaction</li>
                  <li>Ester Schotten-Baumann</li>
                  <li>Fischer-Speier esterification</li>
                  <li>Sulfonic ester Schotten-Baumann</li>
                  <li>Bromo Suzuki coupling</li>
                  <li>Bromo Suzuki-type coupling</li>
                  <li>Chloro Suzuki-type coupling</li>
                  <li>Sonogashira coupling</li>
                  <li>Stille reaction</li>
                  <li>N-Boc protection</li>
                  <li>N-Boc deprotection</li>
                  <li>N-Cbz deprotection</li>
                  <li>N-Bn deprotection</li>
                  <li>CO2H-Et deprotection</li>
                  <li>CO2H-Me deprotection</li>
                  <li>CO2H-tBu deprotection</li>
                  <li>O-Bn deprotection</li>
                  <li>Methoxy to hydroxy</li>
                  <li>Nitro to amino</li>
                  <li>Amide to amine reduction</li>
                  <li>Nitrile reduction</li>
                  <li>Carboxylic acid to alcohol reduction</li>
                  <li>Alcohol to aldehyde oxidation</li>
                  <li>Alcohol to ketone oxidation</li>
                  <li>Sulfanyl to sulfinyl</li>
                  <li>Hydroxy to chloro</li>
                  <li>Carboxylic acid to acid chloride</li>
                </ul>
              </div>
            </template>
          </el-tooltip>
        ...
        <!-- 预测结果展示 -->
        <el-card v-if="predictionResult" class="result-card" style="margin-top: 20px;">

          <p><strong>Class Name:</strong> {{ predictionResult.class_name }}</p>
          <!-- <p><strong>Predicted Class ID:</strong> {{ predictionResult.predicted_class_id }}</p> -->
          <!-- <p><strong>Reaction String ID:</strong> {{ predictionResult.rxn_str_id }}</p> -->
        </el-card>
      </el-card>

      <!-- 添加新反应类型数据训练模型模块 -->
      <el-card v-if="activeModule === 'training'" class="module" style="width: 100%; margin-top: 20px;">
        <h2>添加新反应类型数据训练模型</h2>
...
.result-card{
  ...
  /* 调整选择输入方式标题的字体大小 */
  .method-title {
    font-size: 32px; /* 根据需要调整 */
  }
  /* 调整 el-radio 的标签文字字体大小 */
  :deep(.el-radio__label) {
    font-size: 20px; /* 输入SMILES字符串 */
  }
